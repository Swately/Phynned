// apps/ayama/config/src/ConfigStore.cpp
...
//     subset required by Ayama's own TOML schema.
//
                            ...
                            const char* path) noexcept
{
    ...
    // ── Write TOML ────────────────────────────────────────────────────────
    std::fprintf(f,
        "# Ayama policies configuration\n"
        "# Generated by Ayama v%s — edit with care.\n"
        "# op_mode: \"auto\" | \"assist\" | \"manual\"\n"
        "\n"
        "version = %u\n"
        "op_mode = \"%s\"\n"
        "\n",
        AYAMA_VERSION_STRING, cfg.version, op_mode_str(cfg.op_mode));
