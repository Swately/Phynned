// apps/ayama/learn/include/ayama/learn/PerGameMemory.hpp
...
//
// Persistence:  %LOCALAPPDATA%\Ayama\memory.toml
...
/// Entry in the bad-list: exes where Ayama detected a regression.
...
public:
    ...
    /// Creates the %LOCALAPPDATA%\Ayama\ directory if it does not exist.
    [[nodiscard]] std::expected<void, phyriad::Error>
    ...
    // ── Bad-list management ───────────────────────────────────────────────
    /// Mark an exe as bad — Ayama will not re-apply policies to it.
