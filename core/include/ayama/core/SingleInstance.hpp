// apps/ayama/core/include/ayama/core/SingleInstance.hpp
// SingleInstance — named-mutex guard ensuring only one ayama-agent runs.
//
...
public:
    ...
    [[nodiscard]] bool acquire() noexcept {
#ifdef _WIN32
        mutex_ = CreateMutexW(nullptr, FALSE, L"Local\\AyamaAgentMutex.v1");
        ...
        return true;
#else
        fd_ = open("/tmp/ayama-agent.lock", O_CREAT | O_RDWR, 0666);
