// apps/ayama/core/include/ayama/core/AutoRevertGuard.hpp
// AutoRevertGuard — 30s post-policy monitoring with automatic revert.
//
// After a policy is applied to a target, Ayama monitors frame-time variance
...
namespace ayama::action { class ActionExecutor; }
namespace ayama::learn  { class PerGameMemory; }
