// apps/ayama/observer/include/ayama/observer/TargetMetrics.hpp
...
struct alignas(8) TargetMetrics {
    ...
    uint32_t allowed_core_mask;        //  4B  — mask Ayama constrained to (0 = none)
    ...
    uint32_t hot_tid;                  //  4B  — TID of process's hottest thread
                                       ...
                                       //         via GFR-Ayama-3 extract_threads.
