// apps/ayama/observer/include/ayama/observer/KindOverrides.hpp
...
// Persistence: %LOCALAPPDATA%\Ayama\overrides.txt (Windows) or
//              ~/.config/ayama/overrides.txt (POSIX).
//
#pragma once
...
// Path resolver: %LOCALAPPDATA%\Ayama\overrides.txt or POSIX equivalent.
...
public:
    ...
    bool save() const noexcept {
        ...
        if (!f) return false;
        std::fprintf(f,
            "# Ayama manual TargetKind overrides\n"
