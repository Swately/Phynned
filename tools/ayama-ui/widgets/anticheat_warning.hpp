// apps/ayama/tools/ayama-ui/widgets/anticheat_warning.hpp
                                         ...
                                         bool& out_quit) noexcept
{
    ...
    // ── Body ─────────────────────────────────────────────────────────────────
    ImGui::TextWrapped(
        "Ayama improves game performance by adjusting standard OS settings "
        "for game processes: CPU affinity (which cores a process runs on) "
        "and scheduling priority. Ayama does NOT inject code into games, "
    ...
    ImGui::TextWrapped(
        "We recommend either: (a) disabling Ayama optimisations for the "
        "specific game's executable in the Targets tab, or (b) closing "
        "Ayama entirely before launching a competitive multiplayer match.");
    ImGui::Spacing();
    ...
    ImGui::TextWrapped(
        ...
        "generally safe. Ayama is designed to be observable and reversible "
