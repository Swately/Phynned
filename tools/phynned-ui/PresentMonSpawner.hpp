// tools/phynned-ui/PresentMonSpawner.hpp
...
// PresentMon binary filename — defined by phynned-ui's CMakeLists target_compile_definitions.
#ifndef PHYNNED_PRESENTMON_FILENAME
#  define PHYNNED_PRESENTMON_FILENAME "PresentMon.exe"
#endif

/// Locate PresentMon.exe in the same directory as the running phynned-ui.exe.
...
inline bool locate_presentmon(char* out, uint32_t out_cap) noexcept {
    ...
    const char* fn = PHYNNED_PRESENTMON_FILENAME;
