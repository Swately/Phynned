// apps/ayama/bench/include/ayama/bench/ABRunner.hpp
// ABRunner — orchestrates an automated A/B performance test.
//
// Designed for the tick-loop architecture of ayama-agent.
...
enum class ABPhase : uint8_t {
    ...
    RecordingA = 1,   ///< Collecting baseline (no Ayama policies applied).
