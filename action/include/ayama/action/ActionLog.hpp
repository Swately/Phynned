// apps/ayama/action/include/ayama/action/ActionLog.hpp
...
// AuditLog and AyamaAgentPublisher maintain independent read cursors without
...
struct alignas(8) ActionLogEntry {
    ...
    uint64_t prev_affinity_mask; //  8B  @16 — captured before Ayama changed it
...
///
/// Consumers: AuditLog + AyamaAgentPublisher — each keeps an independent
